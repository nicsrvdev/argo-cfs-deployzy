...
const UUID = process.env.UUID || '9afd1229-b893-40c1-84dd-51e7ce204913'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
              // 哪吒v1的NZ_CLIENT_SECRET或哪吒v0的agent密钥
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'ecloudserv.nicsrv.kdns.fr';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNmIzOWIyMjQ2NzM3OGY2YmQ2YTg3Mjk1YmViMWY2MjEiLCJ0IjoiNjczM2Y1YWUtOGJhNy00NWY1LTlhYzMtZGI4ZTk3MjBjMjEwIiwicyI6Ill6ZzNOelJpTmpFdE9ERmlZeTAwTW1ZekxXSmpabVl0WkRobU9HWTVZelEwWm1FeCJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
const ARGO_PORT = process.env.ARGO_PORT || 8001;            // 固定隧道端口,使用token需在cloudflare后台设置和这里一致
const CFIP = process.env.CFIP || 'saas.sin.fan';        // 节点优选域名或优选ip  
const CFPORT = process.env.CFPORT || 443;                   // 节点优选域名或优选ip对应的端口
const CFP_ID = process.env.CFP_ID || 'dba116a3-782e-4bf5-b893-c104a2595299';
const CFP_SECRET = process.env.CFP_SECRET || 'Adminpwd';
const CFP_URL = process.env.CFP_URL || 'https://runon.eu.cc/update';
const CFP_COLLECT = process.env.CFP_COLLECT || '0';
const CFP_INTERVAL = process.env.CFP_INTERVAL || '60';
...
const CFP_IFACE = process.env.CFP_IFACE || '';
const CFP_RESET_DAY = process.env.CFP_RESET_DAY || '1';
const CFP_CONN_MODE = process.env.CFP_CONN_MODE || 'auto';
const CFP_PING_MODE = process.env.CFP_PING_MODE || 'tcp';
const CFP_DEBUG = process.env.CFP_DEBUG || '0';
...
async function downloadFilesAndRun() {  
  ...
  const filesToAuthorize = [webPath, botPath, cfPath];
